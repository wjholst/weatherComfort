...
comfortIndex = function(temperature,rh,windSpeed) {
    # see http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3801457/    
    
    if (temperature<=40) 
        {ci = windChill (temperature,windSpeed) }
    else 
        {ci =calcHeatComfort (temperature,rh,windSpeed)}
    ci
}    

calcHeatComfort = function (t,rh,ws) {
# see http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3801457/    
